 ...
 * @param {{title: string, value: string, icon: React.ReactNode, color: string}} props
 */
...
/**
 * Componente que exibe os filtros de período, os cards de estatísticas
 * e o gráfico de despesas por categoria para o Dashboard Financeiro.
 */
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        {loading ? (
            ...
            <>
                ...
                value={(summaryData?.averageExpense ?? 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
